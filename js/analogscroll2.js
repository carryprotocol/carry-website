...
(function($, window, document, undefined) {
    ...
    var
        init = analogscroll.fn.init = function(target, o) {
            ...
            var attrs = [],
                mouseEvt = {
                    ...
                    down: function(e) {
                        ...
                        $(document).bind('touchmove', mouseEvt.move);
                        $(document).bind('touchstart', mouseEvt.up);
                    ...
                    up: function() {
                        fn.selection.enable();
                        $(document).unbind('touchmove', mouseEvt.move);
                        $(document).unbind('touchstart', mouseEvt.up);
            ...
            $(el.scrollbar).bind('touchend', function(e) {
                var self = this;
                ...
                $(document).bind('touchstart', function up() {
                    clearTimeout(setting.downKey);
                    fn.selection.enable();
                    $(document).unbind('touchstart', up);
                });
            ...
            $(el.bar).bind('touchend', mouseEvt.down);

            $(el.forward).bind('touchend', function(e) {
                e = e || window.event;
                clearTimeout(setting.downKey);
                fn.preventDefault(e);
            ...
            $(el.back).bind('touchend', function(e) {
                e = e || window.event;
                clearTimeout(setting.downKey);
                fn.preventDefault(e);
